...
enum DataType {INT16, FLOAT, DOUBLE};
enum ByteOrder {BIGEND, LILEND, BSWAP, LSWAP};
...
public:
  ...
  template<typename T>
  T holdingRegisterRead(int id, int address, ByteOrder byteOrder);
