...
int ModbusRTUClientClass::begin(unsigned long baudrate, unsigned long config)
{
...
int ModbusRTUClientClass::begin(RS485Class& rs485, unsigned long baudrate, unsigned long config)
{
  _rs485 = &rs485;
